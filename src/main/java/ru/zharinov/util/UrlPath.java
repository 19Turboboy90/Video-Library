...
public class UrlPath {
    ...
    public static final String SAVE_FEEDBACK = "/add-feedback";
    public static final String ADMIN_PAGE = "/admin";
    public static final String SAVE_DIRECTOR = "/admin/add-director";
    public static final String SAVE_ACTOR = "/admin/add-actor";
    public static final String ADMIN_SAVE_MOVIE = "/admin/add-movie";
    public static final String ADMIN_DELETE_MOVIE = "/admin/delete-movie";
    public static final String DELETE_FEEDBACK = "/delete-feedback";
    public static final String ADMIN_UPDATE_USER = "/admin/update-user";
    ...
    public static final String ADMIN_DELETE_ACTOR = "/admin/delete-actor";
    public static final String ADMIN_DELETE_DIRECTOR = "/admin/delete-director";
    public static final String ADMIN_DELETE_USER = "/admin/delete-user";
}
